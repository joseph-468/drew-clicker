...
pub fn save(mut pkv: ResMut<PkvStore>, player_query: Query<&Player>, time: Res<Time>, mut save_time: ResMut<SaveTime>) {
...
pub fn spawn_buy_menu(mut commands: Commands, asset_server: Res<AssetServer>, player_query: Query<&Player>) {
    let player = player_query.get_single().unwrap();
